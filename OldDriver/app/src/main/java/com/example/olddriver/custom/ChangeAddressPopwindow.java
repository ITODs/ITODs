package com.example.olddriver.custom;
...
import com.example.olddriver.custom.wheelview.OnWheelChangedListener;
import com.example.olddriver.custom.wheelview.OnWheelScrollListener;
import com.example.olddriver.custom.wheelview.WheelView;
import com.example.olddriver.custom.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strCity = "佛山";
    private String strArea = "南海区";
    ...
    public ChangeAddressPopwindow(final Context context) {
        ...
        View view= View.inflate(context,R.layout.popupwindow_city_custom,null);
        ...
        btnSure = (LinearLayout) view.findViewById(R.id.btn_myinfo_sure);
        btnCancel = (LinearLayout)view. findViewById(R.id.btn_myinfo_cancel);
