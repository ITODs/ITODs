...
public class HistoryAdapter extends BaseAdapter{
    ...
    public HistoryAdapter(List<LocationList> locations, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //加载布局为一个视图
        View view=inflater.inflate(R.layout.item_historylist,null);
        LocationList locationList = (LocationList) getItem(position);
        //在view视图中查找id为image_photo的控件
        TextView tv_title= (TextView) view.findViewById(R.id.used_title);
        TextView tv_address= (TextView) view.findViewById(R.id.used_address);
